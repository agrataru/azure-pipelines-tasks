...
describe('AzureRmWebAppDeployment Suite', function() {
    ...
    this.timeout(60000);
     ...
     before((done) => {
        ...
        tl.cp(path.join(__dirname, "..", "node_modules", "azure-pipelines-tasks-webdeployment-common-v2", "Tests", 'L1XmlVarSub', 'Web.config'), path.join(__dirname, "..", "node_modules", "azure-pipelines-tasks-webdeployment-common-v2", "Tests", 'L1XmlVarSub', 'Web_test.config'), '-f', false);
        tl.cp(path.join(__dirname, "..", "node_modules", "azure-pipelines-tasks-webdeployment-common-v2", "Tests", 'L1XmlVarSub', 'Web.Debug.config'), path.join(__dirname, "..", "node_modules", "azure-pipelines-tasks-webdeployment-common-v2", "Tests", 'L1XmlVarSub', 'Web_test.Debug.config'), '-f', false);
        tl.cp(path.join(__dirname, "..", "node_modules", "azure-pipelines-tasks-webdeployment-common-v2", "Tests", 'L1XmlVarSub', 'parameters.xml'), path.join(__dirname, "..", "node_modules", "azure-pipelines-tasks-webdeployment-common-v2", "Tests", 'L1XmlVarSub', 'parameters_test.xml'), '-f', false);
        tl.cp(path.join(__dirname, "..", "node_modules","azure-pipelines-tasks-webdeployment-common-v2","Tests", 'L1XdtTransform', 'Web.config'), path.join(__dirname, "..", "node_modules","azure-pipelines-tasks-webdeployment-common-v2","Tests", 'L1XdtTransform', 'Web_test.config'), '-f', false);
        done();
    });
    after(function() {
        try {
    ...
    it('Runs successfully with XML variable substitution', (done:MochaDone) => {
        ...
        var resultParamFile = ltx.parse(fs.readFileSync(path.join(__dirname,  "..", "node_modules","azure-pipelines-tasks-webdeployment-common-v2","Tests", 'L1XmlVarSub', 'parameters_test.xml')));
        var expectParamFile = ltx.parse(fs.readFileSync(path.join(__dirname,  "..", "node_modules","azure-pipelines-tasks-webdeployment-common-v2","Tests", 'L1XmlVarSub', 'parameters_Expected.xml')));
