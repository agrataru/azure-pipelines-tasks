...
import { PackageType } from 'azure-pipelines-tasks-webdeployment-common-v2/packageUtility';
import path = require('path');
import * as ParameterParser from 'azure-pipelines-tasks-webdeployment-common-v2/ParameterParserUtility';

var webCommonUtility = require('azure-pipelines-tasks-webdeployment-common-v2/utility.js');
