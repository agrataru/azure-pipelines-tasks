...
import { Package } from 'azure-pipelines-tasks-webdeployment-common-v2/packageUtility';
var deployUtility = require('azure-pipelines-tasks-webdeployment-common-v2/utility.js');
var zipUtility = require('azure-pipelines-tasks-webdeployment-common-v2/ziputility.js');
var fileTransformationsUtility = require('azure-pipelines-tasks-webdeployment-common-v2/fileTransformationsUtility.js');

async function main() {
    tl.setResourcePath(path.join( __dirname, 'task.json'));
    tl.setResourcePath(path.join( __dirname, 'node_modules/azure-pipelines-tasks-webdeployment-common-v2/module.json'));
