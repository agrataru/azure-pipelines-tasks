...
describe('IISWebsiteDeploymentOnMachineGroup test suite', function() {
     ...
     before((done) => {
        tl.cp(path.join(__dirname, "..", "node_modules", "azure-pipelines-tasks-webdeployment-common-v2", "Tests", 'L1XmlVarSub', 'Web.config'), path.join(__dirname, "..", "node_modules", "azure-pipelines-tasks-webdeployment-common-v2", "Tests", 'L1XmlVarSub', 'Web_test.config'), null, false);
        tl.cp(path.join(__dirname, "..", "node_modules", "azure-pipelines-tasks-webdeployment-common-v2", "Tests", 'L1XmlVarSub', 'Web.Debug.config'), path.join(__dirname, "..", "node_modules", "azure-pipelines-tasks-webdeployment-common-v2", "Tests", 'L1XmlVarSub', 'Web_test.Debug.config'), null, false);
        tl.cp(path.join(__dirname, "..", "node_modules","azure-pipelines-tasks-webdeployment-common-v2","Tests", 'L1XdtTransform', 'Web.config'), path.join(__dirname, "..", "node_modules","azure-pipelines-tasks-webdeployment-common-v2","Tests", 'L1XdtTransform', 'Web_test.config'), null, false);
        tl.cp(path.join(__dirname, "..", "node_modules", "azure-pipelines-tasks-webdeployment-common-v2", "Tests", 'L1XmlVarSub', 'parameters.xml'), path.join(__dirname, "..", "node_modules", "azure-pipelines-tasks-webdeployment-common-v2", "Tests", 'L1XmlVarSub', 'parameters_test.xml'), null, false);
        done();
    });
    after(function() {
        tl.rmRF(path.join(__dirname, "..", "node_modules","azure-pipelines-tasks-webdeployment-common-v2","Tests", 'L1XdtTransform', 'Web_test.config'));
        tl.rmRF(path.join(__dirname, "..", "node_modules", "azure-pipelines-tasks-webdeployment-common-v2", "Tests", 'L1XmlVarSub', 'Web_test.config'));
        tl.rmRF(path.join(__dirname, "..", "node_modules", "azure-pipelines-tasks-webdeployment-common-v2", "Tests", 'L1XmlVarSub', 'Web_Test.Debug.config'));
        tl.rmRF(path.join(__dirname, "..", "node_modules", "azure-pipelines-tasks-webdeployment-common-v2", "Tests", 'L1XmlVarSub', 'parameters_test.xml'));
    });
    ...
    it('Runs successfully with XDT Transformation (L1)', (done:MochaDone) => {
        ...
        let tp = path.join(__dirname, "..", "node_modules","azure-pipelines-tasks-webdeployment-common-v2","Tests","L1XdtTransform.js");
        let tr : ttm.MockTestRunner = new ttm.MockTestRunner(tp);
        tr.run();

        if(tl.osType().match(/^Win/)) {
            var resultFile = ltx.parse(fs.readFileSync(path.join(__dirname, "..", "node_modules","azure-pipelines-tasks-webdeployment-common-v2","Tests", 'L1XdtTransform', 'Web_test.config')));
            var expectFile = ltx.parse(fs.readFileSync(path.join(__dirname, "..", "node_modules","azure-pipelines-tasks-webdeployment-common-v2","Tests", 'L1XdtTransform','Web_Expected.config')));
    ...
    it('Runs successfully with XML variable substitution', (done:MochaDone) => {
        let tp = path.join(__dirname, "..", "node_modules", "azure-pipelines-tasks-webdeployment-common-v2", "Tests", 'L1XmlVarSub.js');
        let tr : ttm.MockTestRunner = new ttm.MockTestRunner(tp);
        tr.run();
		
        var resultFile = ltx.parse(fs.readFileSync(path.join(__dirname,  "..", "node_modules","azure-pipelines-tasks-webdeployment-common-v2","Tests", 'L1XmlVarSub', 'Web_test.config')));
        var expectFile = ltx.parse(fs.readFileSync(path.join(__dirname, "..", "node_modules","azure-pipelines-tasks-webdeployment-common-v2","Tests", 'L1XmlVarSub', 'Web_Expected.config')));
        assert(ltx.equal(resultFile, expectFile) , 'Should have substituted variables in Web.config file');
        var resultFile = ltx.parse(fs.readFileSync(path.join(__dirname, "..", "node_modules", "azure-pipelines-tasks-webdeployment-common-v2", "Tests", 'L1XmlVarSub', 'Web_test.Debug.config')));
        var expectFile = ltx.parse(fs.readFileSync(path.join(__dirname, "..", "node_modules", "azure-pipelines-tasks-webdeployment-common-v2", "Tests", 'L1XmlVarSub', 'Web_Expected.Debug.config')));
    ...
    it('Runs successfully with JSON variable substitution', (done:MochaDone) => {
        let tp = path.join(__dirname, "..", "node_modules", "azure-pipelines-tasks-webdeployment-common-v2", "Tests", 'L1JsonVarSub.js');
        let tr : ttm.MockTestRunner = new ttm.MockTestRunner(tp);
        tr.run();
    ...
    it('Validate File Encoding', (done:MochaDone) => {
        let tp = path.join(__dirname, "..", "node_modules", "azure-pipelines-tasks-webdeployment-common-v2", "Tests", 'L1ValidateFileEncoding.js');
        let tr : ttm.MockTestRunner = new ttm.MockTestRunner(tp);
        tr.run();
     ...
     it('Validate azure-pipelines-tasks-webdeployment-common-v2.utility.copyDirectory()', (done:MochaDone) => {
        let tp = path.join(__dirname, "..", "node_modules", "azure-pipelines-tasks-webdeployment-common-v2", "Tests", 'L0CopyDirectory.js');
        let tr : ttm.MockTestRunner = new ttm.MockTestRunner(tp);
        tr.run();
    ...
    it('Validate MSDeploy parameters', (done:MochaDone) => {
        let tp = path.join(__dirname, "..", "node_modules","azure-pipelines-tasks-webdeployment-common-v2","Tests","L0MSDeployUtility.js");
        let tr : ttm.MockTestRunner = new ttm.MockTestRunner(tp);
        tr.run();
